  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden" aria-hidden="true">
      ...
      <svg
        ...
        opacity="0.12"
      >
        <path d="M170 400 Q165 350 160 300 Q155 260 148 230 Q140 200 135 180" stroke="#8a4a5c" strokeWidth="8" fill="none" strokeLinecap="round" />
        <path d="M148 230 Q120 210 90 200 Q60 195 40 200" stroke="#8a4a5c" strokeWidth="4" fill="none" strokeLinecap="round" />
        <path d="M155 260 Q170 240 185 235" stroke="#8a4a5c" strokeWidth="3" fill="none" strokeLinecap="round" />
        <path d="M135 180 Q115 150 100 140 Q80 130 60 135" stroke="#8a4a5c" strokeWidth="3" fill="none" strokeLinecap="round" />
        {[
      ...
      <svg
        ...
        opacity="0.08"
      >
        <path d="M10 250 Q20 200 30 170 Q35 150 40 140" stroke="#8a4a5c" strokeWidth="5" fill="none" strokeLinecap="round" />
        <path d="M35 165 Q55 150 70 148 Q85 146 100 150" stroke="#8a4a5c" strokeWidth="3" fill="none" strokeLinecap="round" />
        <path d="M40 140 Q50 120 65 115" stroke="#8a4a5c" strokeWidth="2" fill="none" strokeLinecap="round" />
        {[
...
function SakuraDarkBg() {
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden" aria-hidden="true">
      ...
      {/* Mountains — Fuji-style, black to dark gray */}
      <svg
        className="absolute bottom-0 w-full"
        style={{ height: '45%' }}
        viewBox="0 0 1440 400"
      ...
      >
        ...
        <path
          ...
          opacity="0.8"
        />
        {/* Snow/light caps — very faint */}
        <path d="M180 120 L220 100 L260 120 L240 115 L220 108 L200 115Z" fill="#342e30" opacity="0.5" />
        <path d="M620 80 L660 55 L700 80 L685 75 L660 63 L635 75Z" fill="#342e30" opacity="0.5" />
        <path d="M1060 60 L1100 40 L1140 60 L1125 55 L1100 48 L1075 55Z" fill="#342e30" opacity="0.5" />
      ...
      {/* Sakura tree silhouette — right side, very subtle */}
      <svg
        className="absolute bottom-0 right-0"
        style={{ height: '55%', width: '200px' }}
        viewBox="0 0 200 400"
        ...
        opacity="0.06"
      >
        <path d="M170 400 Q165 350 160 300 Q155 260 148 230 Q140 200 135 180" stroke="#706568" strokeWidth="8" fill="none" strokeLinecap="round" />
        <path d="M148 230 Q120 210 90 200 Q60 195 40 200" stroke="#706568" strokeWidth="4" fill="none" strokeLinecap="round" />
        <path d="M155 260 Q170 240 185 235" stroke="#706568" strokeWidth="3" fill="none" strokeLinecap="round" />
        <path d="M135 180 Q115 150 100 140 Q80 130 60 135" stroke="#706568" strokeWidth="3" fill="none" strokeLinecap="round" />
        {[
          [40, 200], [55, 195], [70, 198], [90, 195],
          [60, 135], [75, 130], [95, 138], [100, 128],
          [185, 230], [178, 238],
          ...
          <circle key={i} cx={cx} cy={cy} r={8 + (i % 3) * 2} fill="#e8899e" opacity={0.15} />
        ))}
      </svg>
    </div>
  )
